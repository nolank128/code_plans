...
<div class="cztable">
	...
	<table border="1" width="100%" class="table_a">
				...
				<tr>
                    <td>户口所在地：</td>
                    <td>
                        <input type="text" name="slocation" value=""  />
                    </td>                
                </tr>
				...
				<tr>
                    <td>政治面貌：</td>
                    <td>
                        <input type="text" name="spolitics" value="" />
                    </td>                
                </tr>
				<tr>
                    <td>身份证号：</td>
                    <td>
                        <input type="text" name="scardid" value="" />
                    </td>                
                </tr>
				...
				<tr>
                    <td>专业：</td>
                    <td>
                        <input type="text" name="sprofession" value="" />
                    </td>                
                </tr>
